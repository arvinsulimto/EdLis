...
import id.rendesvouz.edlis.Victor.Topic.Listening.ListeningPage;
import me.relex.circleindicator.CircleIndicator;

public class WritingTopic extends AppCompatActivity {

    MyPageAdapter pageAdapter;
    ImageButton writing_Backbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar writing_toolbar = (Toolbar) findViewById(R.id.writing_toolbar);
        setSupportActionBar(writing_toolbar);

        writing_Backbtn = (ImageButton) findViewById(R.id.writing_Backbtn);
        ...
        writing_Backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                    getSupportFragmentManager().beginTransaction().remove(topic_place).commit();
    ...
    private List<Fragment> getFragments(){
        ...
        fList.add(WritingPage.newInstance(2, 1));
        fList.add(WritingPage.newInstance(2, 2));
        fList.add(WritingPage.newInstance(2, 3));
