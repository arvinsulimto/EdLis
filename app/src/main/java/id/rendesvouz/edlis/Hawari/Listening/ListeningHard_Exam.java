...
public class ListeningHard_Exam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.getExamData(3,3,getApplicationContext());
        ...
        btn_backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(ListeningHard_Exam.this, ExamMenuListening.class);
        ...
        endExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ListeningHard_Exam.this, ListeningExamResult.class);
