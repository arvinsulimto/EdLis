...
public class ListeningEasy_Exam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.getExamData(3,1,getApplicationContext());
        ...
        btn_backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(ListeningEasy_Exam.this, ExamMenuListening.class);
        ...
        endExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ListeningEasy_Exam.this, ListeningExamResult.class);
