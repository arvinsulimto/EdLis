...
public class ReadingMedium_Exam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.getExamData(1,2,getApplicationContext());
        ...
        btn_backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(ReadingMedium_Exam.this, ExamMenuReading.class);
        ...
        endExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ReadingMedium_Exam.this,ReadingExamResult.class);
