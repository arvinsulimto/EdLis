...
public class ListeningExamResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_endExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ListeningExamResult.this, SelectMaterial.class);
...
//                intent.putExtra("dataEmail",Email);
        ...
        btn_tryAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(LevelID == 1){
                    Intent intent2 = new Intent(ListeningExamResult.this, ListeningEasy_Exam.class);
//                    intent2.putExtra("dataUsername",Username);
//                    intent2.putExtra("dataEmail",Email);
                    startActivity(intent2);
                    finish();
                }else if(LevelID == 2){
                    Intent intent3 = new Intent(ListeningExamResult.this, ListeningMedium_Exam.class);
//                    intent3.putExtra("dataUsername",Username);
//                    intent3.putExtra("dataEmail",Email);
                    startActivity(intent3);
                    finish();
                }else if(LevelID == 3) {
                    Intent intent4 = new Intent(ListeningExamResult.this, ListeningHard_Exam.class);
...
//                    intent4.putExtra("dataEmail", Email);
        ...
        btn_backArrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(ListeningExamResult.this, ExamMenuListening.class);
//                intent3.putExtra("dataUsername",Username);
//                intent3.putExtra("dataEmail",Email);
                startActivity(intent3);
                finish();
