...
public class WritingEasy_Exam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.getExamData(2,1,getApplicationContext());
        ...
        btn_backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(WritingEasy_Exam.this, ExamMenuWriting.class);
        ...
        endExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WritingEasy_Exam.this,WritingExamResult.class);
