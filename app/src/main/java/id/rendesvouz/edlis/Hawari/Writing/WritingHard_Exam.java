...
public class WritingHard_Exam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.getExamData(2,3,getApplicationContext());
        ...
        btn_backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent2 = new Intent(WritingHard_Exam.this, ExamMenuWriting.class);
        ...
        endExam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WritingHard_Exam.this,WritingExamResult.class);
